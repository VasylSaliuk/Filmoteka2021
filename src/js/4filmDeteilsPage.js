...
refs.sliderImg =document.addEventListener('click', onClickSlider)
refs.filmItem.addEventListener('click', onClickFilm);
// controlModal( refs.filmItem, refs.sliderImg) 


export function onClickFilm(e) {
  // console.log(e);
  refs.sliderImg.removeEventListener('click', onClickSlider)
  ...
  export function onClickSlider(e){
    const filmId = e.target.id;
